...
/* Table for use with NX-Kernel for Samsung GT-N7000 */
static int tb_freqs_power[16][3]={
    {1600000,1600000,1500000},
    {1500000,1600000,1400000},
    {1400000,1500000,1300000},
    {1300000,1400000,1200000},
...
// Modified to be hotplug-able and optimzed for use with Samsung GT-N7000.

MODULE_DESCRIPTION("'cpufreq_abyssplugV2' - A dynamic cpufreq governor based "
"cpufreq_conservative from Alexander Clouter. Optimized for use with NX-Kernel"
"using frequency lookup tables and CPU hotplug - ported/modified for GT-N7000 by neobuddy89");
MODULE_LICENSE("GPL");
